...
set_property MARK_DEBUG true [get_nets U_DrsControl_n_32]
...
set_property MARK_DEBUG true [get_nets drsStopSampleValid]
set_property MARK_DEBUG true [get_nets drsRsrLoad_OBUF]
set_property MARK_DEBUG true [get_nets {drsStopSampleArr[0][0]}]
set_property MARK_DEBUG true [get_nets {drsStopSampleArr[0][1]}]
set_property MARK_DEBUG true [get_nets {drsStopSampleArr[0][2]}]
set_property MARK_DEBUG true [get_nets {drsStopSampleArr[0][3]}]
set_property MARK_DEBUG true [get_nets {drsStopSampleArr[0][4]}]
set_property MARK_DEBUG true [get_nets {drsStopSampleArr[0][5]}]
set_property MARK_DEBUG true [get_nets {drsStopSampleArr[0][6]}]
set_property MARK_DEBUG true [get_nets {drsStopSampleArr[0][7]}]
set_property MARK_DEBUG true [get_nets {drsStopSampleArr[0][8]}]
set_property MARK_DEBUG true [get_nets {drsStopSampleArr[0][9]}]
connect_debug_port u_ila_0/probe7 [get_nets [list U_DrsControl_n_32]]


set_property MARK_DEBUG true [get_nets {adcDataValid[0]}]
set_property MARK_DEBUG true [get_nets {adcDataValid[1]}]

set_property MARK_DEBUG false [get_nets {ADC_GEN[0].U_AdcReadout/iAdcConvClkR}]
set_property MARK_DEBUG true [get_nets {ADC_GEN[0].U_AdcReadout/adcConvClk}]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {adcData[0][0]} {adcData[0][1]} {adcData[0][2]} {adcData[0][3]} {adcData[0][4]} {adcData[0][5]} {adcData[0][6]} {adcData[0][7]} {adcData[0][8]} {adcData[0][9]} {adcData[0][10]} {adcData[0][11]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 1 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {adcDataValid_orig__0[1]}]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe3 [get_nets [list {adcData[32][0]} {adcData[32][1]} {adcData[32][2]} {adcData[32][3]} {adcData[32][4]} {adcData[32][5]} {adcData[32][6]} {adcData[32][7]} {adcData[32][8]} {adcData[32][9]} {adcData[32][10]} {adcData[32][11]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 10 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list {drsStopSampleArr[0][0]} {drsStopSampleArr[0][1]} {drsStopSampleArr[0][2]} {drsStopSampleArr[0][3]} {drsStopSampleArr[0][4]} {drsStopSampleArr[0][5]} {drsStopSampleArr[0][6]} {drsStopSampleArr[0][7]} {drsStopSampleArr[0][8]} {drsStopSampleArr[0][9]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe5]
set_property port_width 1 [get_debug_ports u_ila_0/probe5]
connect_debug_port u_ila_0/probe5 [get_nets [list {ADC_GEN[0].U_AdcReadout/adcConvClk}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe6]
set_property port_width 1 [get_debug_ports u_ila_0/probe6]
connect_debug_port u_ila_0/probe6 [get_nets [list adcSync]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe7]
set_property port_width 1 [get_debug_ports u_ila_0/probe7]
connect_debug_port u_ila_0/probe7 [get_nets [list drsRsrLoad_OBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe8]
set_property port_width 1 [get_debug_ports u_ila_0/probe8]
connect_debug_port u_ila_0/probe8 [get_nets [list drsSampleValid]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe9]
set_property port_width 1 [get_debug_ports u_ila_0/probe9]
connect_debug_port u_ila_0/probe9 [get_nets [list drsSrClk_OBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe10]
set_property port_width 1 [get_debug_ports u_ila_0/probe10]
connect_debug_port u_ila_0/probe10 [get_nets [list drsStopSampleValid]]
